...
global_symbol_table.set_sys_var('i32_to_i64',               BuiltInFunction.i32_to_i64)
global_symbol_table.set_sys_var('i64_to_i32',               BuiltInFunction.i64_to_i32)
global_symbol_table.set_sys_var('f32_to_i32',               BuiltInFunction.f32_to_i32)
global_symbol_table.set_sys_var('f32_to_i64',               BuiltInFunction.f32_to_i64)
global_symbol_table.set_sys_var('limited_int_to_f32',       BuiltInFunction.limited_int_to_f32)
...
global_symbol_table.set_sys_var('f16m_fill',                BuiltInFunction.f16m_fill)
global_symbol_table.set_sys_var('f32m_fill',                BuiltInFunction.f32m_fill)
