...
// TEST: gcc -o '/Volumes/Data stuffs/Python/AILang/c_lib/float16/test/test' -O3 -Xpreprocessor -fopenmp -lomp -fomit-frame-pointer -mf16c '/Volumes/Data stuffs/Python/AILang/c_lib/float16/test/test.c' '/Volumes/Data stuffs/Python/AILang/c_lib/float16/c_src/float16.c'
//USER-DEFINED TEST PROGRAM
int main() {
    F16Comp *impl = calloc(1, sizeof(F16Comp));
    impl->add = f16_add;
    impl->sub = f16_sub;
    impl->mul = f16_mul;
    impl->div = f16_div;
