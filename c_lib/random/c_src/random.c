...
f16resWboolErr_t bounded_gen_local_pcgf16(pcg32x2_random_t* rng, float16_t lower_bound, float16_t upper_bound) {
    ...
    float64_t f64_preprocessed = (float64_t)(pcg32x2_random_r(rng))/((float64_t)UINT64_MAX)*FLOAT16_TO_FLOAT64(f16_sub(upper_bound, lower_bound)) + lower_bound;
...
f32resWboolErr_t bounded_gen_local_pcgf32(pcg32x2_random_t* rng, float32_t lower_bound, float32_t upper_bound) {
    ...
    float64_t f64_preprocessed = (float64_t)(pcg32x2_random_r(rng))/((float64_t)UINT64_MAX)*((float64_t)(upper_bound - lower_bound)) + lower_bound;
