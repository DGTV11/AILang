...
from extra_modules.constant_system_values import SCIENTIFIC_STR_BUF_SIZE, INT_STR_BUF_SIZE, LONG_STR_BUF_SIZE
from extra_modules.numbers import numbers_c, f16, f32, f64, i32, i64
...
def matrix_cast(m: matrix_t, tgt_type: type) -> matrix_t: #TODO: FIX ERROR! (var x: Int32Matrix = matrix_fill(10b, 10b, 10i);matrix_cast(x, Float16Matrix))
